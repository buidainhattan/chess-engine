#include "move_generator_header.hpp"
#include <limits>

using namespace std;

MoveGenerator::MoveGenerator(ChessBoard &chessBoard) : chessBoard(chessBoard)
{
...
vector<Move> MoveGenerator::generateLegalMoves()
{
    ...
    if (enemyColor == white)
    {
        eastAttack = &MoveGenerator::whitePawnNEastAttacks;
        westAttack = &MoveGenerator::whitePawnNWestAttacks;
    }
    else
    {
        eastAttack = &MoveGenerator::blackPawnSWestAttacks;
        westAttack = &MoveGenerator::blackPawnSEastAttacks;
    }
...
void MoveGenerator::generatePawnsMoves(vector<Move> &legalMoves, Color sideToMove, U64 pawns, int kingSquare, U64 enemyPieces, U64 pushMask, U64 captureMask, U64 pinRay, U64 othogonalPinRay, U64 diagonalPinRay)
{
    ...
    if (sideToMove == white)
    {
        singlePush = &MoveGenerator::whitePawnSinglePush;
        doublePush = &MoveGenerator::whitePawnDoublePush;
        eastAttack = &MoveGenerator::whitePawnNEastAttacks;
        westAttack = &MoveGenerator::whitePawnNWestAttacks;
        moveOffSet = 1;
    ...
    {
        singlePush = &MoveGenerator::blackPawnSinglePush;
        doublePush = &MoveGenerator::blackPawnDoublePush;
        eastAttack = &MoveGenerator::blackPawnSWestAttacks;
        westAttack = &MoveGenerator::blackPawnSEastAttacks;
        moveOffSet = -1;
...
void MoveGenerator::generateKnightsMoves(vector<Move> &legalMoves, Color sideToMove, U64 knights, U64 enemyPieces, U64 pushMask, U64 captureMask, U64 pinRay)
{
    while (knights)
    {
...
void MoveGenerator::generateKingMoves(vector<Move> &legalMoves, Color sideToMove, U64 king, U64 enemyPieces, U64 dangerSquaresMask)
{
...
void MoveGenerator::generateSlidingPiecesMoves(vector<Move> &legalMoves, Color sideToMove, U64 othogonalPieces, U64 diagonalPieces, U64 enemyPieces, U64 pushMask, U64 captureMask, U64 pinRay, U64 othogonalPinRay, U64 diagonalPinRay)
{
...
U64 MoveGenerator::getPawnPseudoLegalAttackBitBoard(int square, Color color)
{
    return (pawnAttacksLookupTable[color][square] & chessBoard.pieceColorBitboards[!color]);
}

U64 MoveGenerator::getKnightPseudoLegalAttackBitBoard(int square, Color color)
{
    return (knightAttacksLookupTable[square] & ~chessBoard.pieceColorBitboards[color]);
}

U64 MoveGenerator::getKingPseudoLegalAttackBitBoard(int square, Color color)
{
...
U64 MoveGenerator::squareAttackingBy(int square, U64 allPieces)
{
...
U64 MoveGenerator::attacksToKing(int square, Color kingSide)
{
...
U64 MoveGenerator::attacksToKing(int square, Color kingSide, U64 allPieces)
{
...
U64 MoveGenerator::absolutePinPieces(int square, Color kingColor)
{
...
U64 MoveGenerator::rookXRayAttacks(int square, U64 blockers, U64 occupancy)
{
...
U64 MoveGenerator::bishopXRayAttacks(int square, U64 blockers, U64 occupancy)
{
...
U64 MoveGenerator::generateKnightAttacksMask(int square)
{
...
U64 MoveGenerator::generateKingAttacksMask(int square)
{
...
U64 MoveGenerator::generateWhitePawnAttackMask(int square)
{
...
U64 MoveGenerator::generateBlackPawnAttackMask(int square)
{
...
U64 MoveGenerator::whitePawnSinglePush(U64 whitePawns)
{
    return northShiftOne(whitePawns) & chessBoard.empty;
}

U64 MoveGenerator::whitePawnDoublePush(U64 whitePawns)
{
...
U64 MoveGenerator::blackPawnSinglePush(U64 blackPawns)
{
    return southShiftOne(blackPawns) & chessBoard.empty;
}

U64 MoveGenerator::blackPawnDoublePush(U64 blackPawns)
{
...
U64 MoveGenerator::whitePawnPseudoLegalCaptures(U64 whitePawns, U64 blackPieces)
{
    return blackPieces & whitePawnsAnyAttacks(whitePawns);
}

U64 MoveGenerator::blackPawnPseudoLegalCaptures(U64 blackPawns, U64 whitePieces)
{
    return whitePieces & blackPawnAnyAttacks(blackPawns);
}

U64 MoveGenerator::whitePawnSafeSquares(U64 whitePawns, U64 blackPawns)
{
...
U64 MoveGenerator::blackPawnSafeSquares(U64 whitePawns, U64 blackPawns)
{
...
U64 MoveGenerator::whitePawnSoloAttacks(U64 whitePawns)
{
    return whitePawnNEastAttacks(whitePawns) ^ whitePawnNWestAttacks(whitePawns);
}

U64 MoveGenerator::whitePawnDuoAttacks(U64 whitePawns)
{
    return whitePawnNEastAttacks(whitePawns) & whitePawnNWestAttacks(whitePawns);
}

U64 MoveGenerator::whitePawnsAnyAttacks(U64 whitePawns)
{
    return whitePawnNEastAttacks(whitePawns) | whitePawnNWestAttacks(whitePawns);
}

U64 MoveGenerator::whitePawnNEastAttacks(U64 whitePawns)
{
    return northEastShiftOne(whitePawns);
}

U64 MoveGenerator::whitePawnNWestAttacks(U64 whitePawns)
{
    return northWestShiftOne(whitePawns);
}

U64 MoveGenerator::blackPawnSoloAttacks(U64 blackPawns)
{
    return blackPawnSEastAttacks(blackPawns) ^ blackPawnSWestAttacks(blackPawns);
}

U64 MoveGenerator::blackPawnDuoAttacks(U64 blackPawns)
{
    return blackPawnSEastAttacks(blackPawns) & blackPawnSWestAttacks(blackPawns);
}

U64 MoveGenerator::blackPawnAnyAttacks(U64 blackPawns)
{
    return blackPawnSEastAttacks(blackPawns) | blackPawnSWestAttacks(blackPawns);
}

U64 MoveGenerator::blackPawnSEastAttacks(U64 blackPawns)
{
    return southEastShiftOne(blackPawns);
}

U64 MoveGenerator::blackPawnSWestAttacks(U64 blackPawns)
{
    return southWestShiftOne(blackPawns);
}

void MoveGenerator::generateNonSlidingPieceLookupTable(U64 (&arr)[64], PieceType pieceType, Color color)
{
    generateFunctionPointer moveGeneration;
    if (pieceType == pawn)
    {
        moveGeneration = color == white ? &MoveGenerator::generateWhitePawnAttackMask : &MoveGenerator::generateBlackPawnAttackMask;
    }
    else
    {
        moveGeneration = pieceType == knight ? &MoveGenerator::generateKnightAttacksMask : &MoveGenerator::generateKingAttacksMask;
    }
...
vector<U64> MoveGenerator::generateSlidingPieceLookupTable(PieceType pieceType)
{
...
void MoveGenerator::populateRectangular()
{
