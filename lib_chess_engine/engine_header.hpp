...
public:
    ...
    // MiniMax search algorithm - TO DO
    ...
    // Whether there are any blockers in between or not
    bool canMove(int fromSquare, int toSquare, U64 blockers);
    ...
    // All sliding pieces x-ray attacks - To Do
    U64 xRayAttacks();

private:
    using generateFunctionPointer = U64 (Engine::*)(int);
    using pawnsFunctonPointer = U64 (Engine::*)(U64);
